...
const SkillSection = React.forwardRef(({ title, skills }, ref) => (
  <div className="flex flex-col h-full skill-section" ref={ref}>
    <div className="w-full border border-colors-pink-1 py-8 px-4 rounded-2xl bg-gradient-to-r from-gray-900 to-black hover:from-black hover:to-gray-900 hover:scale-105 transform transition-transform duration-300 ease-out shadow-lg hover:shadow-2xl flex flex-col h-full">
      <h3 className="text-3xl md:text-4xl text-center text-colors-pink-1 font-bold mb-6">
        {title}
      </h3>
  ...
  return (
    <div className="flex flex-col items-center hover:shadow-xl transform hover:scale-105 transition-transform duration-300">
      <img
        ...
        alt={skill.skillName}
        className="w-10 h-10 object-cover shadow-lg mb-2"
      />
    </div>
  );
};
